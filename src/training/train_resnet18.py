...
Checkpoints and logs are saved under:
    checkpoints/<experiment_name>/<model>/   resnet18_epoch_NN.pth
...
Usage (from project root in Colab):
    ...
    python -m src.training.train_resnet18 --dataset dataset_combined

    # DoG preprocessing experiment (experiments 11/12)
    python -m src.training.train_resnet18 --dataset dataset_combined --dog --experiment_name dataset_combined_dog

    # Resume an interrupted run
    python -m src.training.train_resnet18 --dataset dataset_b --resume
"""
