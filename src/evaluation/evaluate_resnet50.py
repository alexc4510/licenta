...
Usage (from project root):
    ...
    python -m src.evaluation.evaluate_resnet50 --dataset dataset_b --checkpoint_dataset dataset_combined

    # DoG evaluation (experiments 11/12)
    python -m src.evaluation.evaluate_resnet50 --dataset dataset_b --experiment_name dataset_combined_dog --dog
    python -m src.evaluation.evaluate_resnet50 --dataset dataset_c --experiment_name dataset_combined_dog --dog
    python -m src.evaluation.evaluate_resnet50 --dataset ai_vs_human --experiment_name dataset_combined_dog --dog

    # Balanced test split (experiments 7/8)
    python -m src.evaluation.evaluate_resnet50 --dataset dataset_b_balanced --test_split test_balanced
"""
...
def main() -> None:
    ...
    # Determine where to find the checkpoint
